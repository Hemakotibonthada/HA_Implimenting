...
Ticker switch1OnTicker;
Ticker switch1OffTicker;
...
void setup() {
    ...
    // Schedule switch 1 to turn on at 8:00 AM and off at 8:00 PM
    switch1OnTicker.attach(8 * 3600, turnSwitch1On);  // 8:00 AM
    switch1OffTicker.attach(20 * 3600, turnSwitch1Off); // 8:00 PM
}
